...
<div class="wrapper">
	...
	<div class="mt-4 flex justify-around gap-4">
		<button onclick={cancelCrop} aria-label="Cancel Crop" class="btn preset-filled-error-500">Cancel</button>
		<button onclick={resetCrop} aria-label="Reset Crop" class="preset-outline btn">Reset</button>
		<button onclick={applyCrop} aria-label="Apply Crop" class="btn preset-filled-primary-500">
