...
<div class="wrapper">
	...
	<button onclick={exitShapeOverlay} class="preset-ghost-primary btn-icon absolute -top-2 right-2 font-bold"> Exit </button>
	...
	<div class="mt-4 flex justify-between space-x-2">
		<button onclick={addShape} class="btn w-full preset-filled-primary-500">Add Shape</button>
		<button onclick={deleteSelectedShape} class="btn w-full preset-filled-error-500" disabled={!selectedShape}>Delete</button>
