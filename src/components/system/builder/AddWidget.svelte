...
<div class="fixed -top-16 left-0 flex h-screen w-full flex-col overflow-auto bg-white dark:bg-surface-950">
	<div class="mb-3 flex items-center justify-between text-surface-950 dark:text-white">
	...
	{:else}
		<div class="flex-col items-center justify-center overflow-auto">
			...
			<div class="w-100 mx-2 mb-2 flex justify-between gap-2">
				<button class="btn preset-filled-tertiary-500 dark:preset-filled-primary-500" onclick={handleSave}>
					Save {selected_widget} Widget
				</button>
				<button class="dark:preset-ghost-secondary btn preset-filled-secondary-500" onclick={handleWidgetCancel}>Cancel</button>
			</div>
